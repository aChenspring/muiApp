...
//		}
		...
		//home ip
		var url = "http://172.18.1.222:8080/h5plus/login?pUserName=" + loginInfo.account + "&pUserPwd=" + loginInfo.password;
		var xhr = null;
		if (xhr) {
	...
	owner.editPass = function(editInfo, callback) {
		...
		var url = "http://192.168.0.101:8080/h5plus/registration?email=achenspring@163.com";
		var xhr = null;
		if (xhr) {
